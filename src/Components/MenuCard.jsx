...
const MenuCard = ({ foodImg, foodName, foodPrice, foodRecipe }) => {
  return (
    <div className="bg-gray-50 rounded-2xl flex items-center gap-6 p-2">
      <img
        src={foodImg}
        alt=""
      ...
      <div className="flex justify-between items-start gap-4">
        <div>
          ...
          <p className="font-Inter leading-7 text-color4">{foodRecipe}</p>
        </div>
